    ...
    async publishSite() {
        ...
        while (retry < maxRetry) {
            try {
                ...
                // await this.page.waitForTimeout(500)
                // await this.page.waitForSelector('div.jzUkr > div:nth-child(2)', { visible: true });
            ...
            while (retry < maxRetry) {
                try {
                    ...
                    for (let k = 1; k <= 20; k++) {
                        ...
                        if (k == 100) {
                            throw new Error(`Gagal menyimpan 100x, progress akan dihapus`);
                        }
                    }
                    ...
                    try {
                        ...
                        for (let m = 1; m <= 10; m++) {
                            ...
                            if (m == 10) {
                                console.log(chalk.red(`Gagal menyimpan 100x, halaman tidak direload`));
                            }
                        }
                        await this.page.setDefaultTimeout(this.defaultTimeOut);
                        if (isReload) {
...
(async() => {
    ...
    csv()
        ...
        .then((content) => {
            ...
            // if (profileOneTool.isExistProfile) {
